...
const HardwarePage = lazy(() => import("@/pages/it/Hardware/HardwarePage"));

const DashboardLayout = lazy(
    () => import("@/components/layouts/DashboardLayout")
);

const SoftwarePage = lazy(() => import("@/pages/it/software/SoftwarePages"));
...
const FurniturePage = lazy(
    () => import("@/pages/assets/Furniture/FurniturePages")
);
const LicensePage = lazy(
    () => import("@/pages/company-document/license/LicensePage")
);
const LegalDocumentPage = lazy(
    () => import("@/pages/company-document/legal-document/LegalDocumentPage")
);
const AduitReportPage = lazy(
    () => import("@/pages/company-document/audit-report/AuditReportPage")
);
const ISOCertificationsPage = lazy(
    () =>
        import(
            "@/pages/company-document/iso-certifications/ISOCertificationsPage"
        )
);
...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            {
                path: "assets",
                element: <Navigate to="/assets/land-building" replace />,
            },
            ...
            {
                path: "/banking",
                element: <Navigate to="/banking/cheque-printing" replace />,
            },
            {
            ...
            {
                path: "/banking/cheque-printing/business-contacts",
                element: (
                    <Suspense fallback={<LoadingFallback />}>
            ...
            {
                path: "docs",
                element: <Navigate to="/docs/licence" replace />,
            },
            {
            ...
            {
                path: "it",
                element: <Navigate to="/it/hardware" replace />,
            },
            {
