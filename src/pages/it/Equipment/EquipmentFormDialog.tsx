...
const EquipmentFormDialog: React.FC<Props> = ({
  ...
  const footer = (
    <>
      <Button form="network-equipment-form" type="submit" size="sm" disabled={submitting}>
        {submitting ? (
          <>
  ...
  return (
    <CustomDialog
      ...
      title={mode === "add" ? "Add Equipment" : `Edit: ${form.equipmentName || ""}`}
      description={mode === "add" ? "Create a new network equipment record." : "Update equipment details."}
      footer={footer}
    >
      <form
        id="network-equipment-form"
