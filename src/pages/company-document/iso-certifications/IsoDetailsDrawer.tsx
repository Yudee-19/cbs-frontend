...
import type { Iso } from "@/services/company-documents/IsoServices";
...
export const IsoDetailsDrawer: React.FC<Props> = ({ open, item, onClose }) => {
  return (
        ...
        <div className="relative flex flex-col h-full">
          <DrawerHeader>
            <div className="flex items-start justify-between w-full">
              <DrawerTitle>{`ISO Certificate: ${item?.certificateName ?? ""}`}</DrawerTitle>
              <DrawerClose asChild>
