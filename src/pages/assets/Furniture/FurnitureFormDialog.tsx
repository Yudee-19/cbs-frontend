  ...
  return (
    <Dialog open={open} onOpenChange={(v) => (!v ? onClose() : null)}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>{mode === "add" ? "New Furniture" : `Edit: ${form.itemName ?? ""}`}</DialogTitle>
          <DialogDescription>{mode === "add" ? "Add furniture item." : "Update furniture item."}</DialogDescription>
        </DialogHeader>
