  ...
  return (
    <Dialog open={open} onOpenChange={(v) => (!v ? onClose() : null)}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>{mode === "add" ? "New Equipment" : `Edit: ${form.equipmentName ?? ""}`}</DialogTitle>
          <DialogDescription>{mode === "add" ? "Add equipment details." : "Update equipment details."}</DialogDescription>
        </DialogHeader>
